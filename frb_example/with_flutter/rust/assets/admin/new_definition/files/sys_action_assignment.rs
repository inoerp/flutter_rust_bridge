...
mod tests {
    use crate::{
        ...
        model::{entity::action::sys_action_assignment::SysActionAssignment, state::global_state::GlobalState}, startup,
    };
    ...
    async fn test_find_all() {
        ...
        let all_data = SysActionAssignment::find_all(conn).await.expect("Unable to find result");
