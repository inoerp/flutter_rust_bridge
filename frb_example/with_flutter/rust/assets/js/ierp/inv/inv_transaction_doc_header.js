...
function allowTransaction(data) {
  ...
  let selectSql =
    " SELECT doc_status FROM inv_transaction_doc_line where inv_transaction_doc_header_id = '" +
...
function validateTransaction(data) {
  ...
  let selectSql =
    ...
    FROM inv_transaction_doc_line_ev line,  \
...
function updateLineStatus(invTransactionDocHeaderId) {
  let updateSql =
    " UPDATE inv_transaction_doc_line SET doc_status = 'validated' \
